...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Card container */}
      <div className="backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-zinc-700/50 overflow-hidden">
        {/* Orange header with logo & branding */}
        <div className="bg-primary px-8 md:px-10 py-8 flex flex-col items-center">
          <div className="bg-white size-16 rounded-2xl flex items-center justify-center p-2 shadow-xl shadow-black/20 mb-4">
        ...
        {/* Form section */}
        <div className="bg-white/95 dark:bg-zinc-900/95 px-8 md:px-10 py-8">
        {/* Welcome Text */}
        <div className="mb-8">
